...
FULL_REWRITE_USER_TEMPLATE = """# Top Performing Programs
- Current performance metrics: {metrics}
- Areas identified for improvement: {improvement_areas}
...
# Task
Generate a NEW program that improves upon the above programs.

The new program should aim to:
- Achieve HIGHER validation accuracy
- Use FEWER parameters

IMPORTANT:
- Provide the complete program
- Keep input/output format unchanged
- Do NOT copy existing programs directly
- Combine and improve their ideas
