...
TARGET_FUNCTION = "build_policy_net"
...
class CartPoleModelSearch:
    def __init__(self):
        ...
        self.evaluator = load_module(self.evaluator_path, "cartpole_evaluator")
    ...
    def _validate_region_code(self, region_code: str) -> None:
        ...
        required_patterns = [
            f"def {TARGET_FUNCTION}(input_dim, output_dim):",
            "policy_net =",
            "return policy_net",
        ]
