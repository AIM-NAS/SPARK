...
class QwenAPI(sampler.LLM):
    ...
    def __init__(self, samples_per_prompt: int, trim: bool = True) -> None:
        ...
        if not self._api_key:
            raise ValueError("FUNSEARCH_API_KEY is empty. Please export your DashScope-compatible API key.")
...
def build_model(input_size=40, output_size=10):
    ...
    6. Keep exactly the same initial architecture style as ConvBase.
    """
...
if __name__ == '__main__':
    ...
    log_dir = os.getenv("FUNSEARCH_LOG_DIR", "logs/funsearch_mnist1d_qwen_api")
