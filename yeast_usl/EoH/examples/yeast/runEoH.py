...
from prob import YeastSimpleMLPSearch
...
# -------------------------
paras = Paras()
problem_local = YeastSimpleMLPSearch()

llm_api_endpoint = os.getenv("EOH_LLM_API_ENDPOINT", os.getenv("EOH_API_ENDPOINT", "https://dashscope.aliyuncs.com/compatible-mode/v1"))
llm_api_key = os.getenv("EOH_LLM_API_KEY", os.getenv("EOH_API_KEY", " "))
...
paras.set_paras(
    ...
    exp_debug_mode=bool(int(os.getenv("EOH_DEBUG_MODE", os.getenv("EOH_DEBUG", "1")))),
...
if not paras.llm_api_key:
    raise RuntimeError("Missing EOH_LLM_API_KEY or EOH_API_KEY environment variable")
